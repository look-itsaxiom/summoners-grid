import type { SpeciesTemplate, SpeciesId } from '../types';

export const SPECIES: Record<SpeciesId, SpeciesTemplate> = {
  gignen: {
    id: 'gignen',
    name: 'Gignen',
...
export function getSpeciesTemplate(speciesId: SpeciesId): SpeciesTemplate {
